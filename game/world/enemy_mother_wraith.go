...
func SpawnMotherWraith(world *World, position, angles mgl32.Vec3) (id scene.Id[*Enemy], enemy *Enemy, err error) {
	...
	texture := cache.GetTexture("assets/textures/sprites/mother_wraith.png")
	floatAnim, _ := texture.GetAnimation("float;front")
	...
	enemy.AnimPlayer = comps.NewAnimationPlayer(floatAnim, false)
	enemy.WakeTime = 0.5
	enemy.WakeLimit = 5.0
